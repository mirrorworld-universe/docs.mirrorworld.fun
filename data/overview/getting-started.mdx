...
## Create an account
To get started, visit [Create a developer account](https://app.mirrorworld.fun/auth/login). You will need this account to access all the features we provided. If you encounter any issues with your account, you can [contact us](mailto:sdk@mirrorworld.fun) or join our [Discord](https://mirrorworld.fun/discord) and [Telegram](https://mirrorworld.fun/telegram) communities to report to our team directly.

![alt](https://market-assets.mirrorworld.fun/process/step1.png)

## Create your project
Once you've signed in dashboard, you will be directed to our home page, which contains some resources that help you better understand how to use our SDK as well as find some support during the development process.
...
## Start building
Congratulations! You have completed everything you need to prepare to integrate our SDK. Below are some links to help you get started with developing for your app.

### Import SDK
  - [Android SDK](https://docs.mirrorworld.fun/android/android-authentication)
  - [Unity SDK](https://docs.mirrorworld.fun/unity/unity-installation)
  - [JavaScript / Typescript SDK](https://docs.mirrorworld.fun/js/js-installation)
  - [Android SDK](https://docs.mirrorworld.fun/android/ios-installation)
