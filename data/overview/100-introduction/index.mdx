...
The Mirror World SDK was built to make it convenient for developers to onboard their users onto Web 3, easily
convert their users into customers and simplify the process of on-chain interactions with the non-custodial wallet
created for each users.

## Features
The core features provided by Mirror World Smart SDK are:
1. Authentication Service
2. Marketplace & NFT Service
3. Wallet Service
...
### Our Focus on Mobile
One core emphasis that the team at Mirror World has focused on is Mobile. We believe strongly that the future is mobile.
As builders of games ourselves, we are familiar with the problems within traditional game development, which include on-boarding for Web3,
