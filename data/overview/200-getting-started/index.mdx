...
window.mixgather.event("join_telegram");window.open("https://mirrorworld.fun/discord");}}> [Discord]()</span> and<span onClick={() =>{window.mixgather.event("join_discord"); window.open("https://mirrorworld.fun/telegram")}} > [Telegram](https://mirrorworld.fun/telegram)</span> communities to report to our team directly.
