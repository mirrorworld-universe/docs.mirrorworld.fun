...
To get started, <span onClick = {()=> {
window.mixgather.event("developer_dashboard");
}}>[Create a developer account](https://app.mirrorworld.fun)</span>. You will
need this account to access all the features we provide. If you encounter any
issues with your account, you can <span 
onClick = {() => {window.mixgather.event("contact_us")}}>[contact us](mailto:sdk@mirrorworld.fun)</span>
or join our<span onClick={() => {window.mixgather.event("join_telegram")}}>
[Discord](https://mirrorworld.fun/discord)</span> and<span 
onClick={() =>{window.mixgather.event("join_discord")}}>
[Telegram](https://mirrorworld.fun/telegram)</span> communities to report to our
team directly.

![Create Account](/images/tutorials/create-account.png)
...
> Mirror World prepares some valuable materials to help with your development.
>
> 1. Tutorials: Integration steps for Unity, iOS, Android, Rush, and JavaScript.
> 2. YouTube: Mirror World SDK Usage Tutorial Videos.
> 3. Community: Links for Discord, Twitter, Telegram, and Blog.

![Create Project](/images/tutorials/create-project.png)

<p align="center">The Home page</p>

Go ahead and click the "Add Project" button to start your first project! Enter your project name in the popup and click "Create".

![Add Project](/images/tutorials/add-project.png)
...
![Project Page Screenshot](/images/tutorials/project-scrnsht1.png)

<p align="center">Visit from the Projects page</p>

![Project Page Screenshot](/images/tutorials/project-scrnsht2.png)
