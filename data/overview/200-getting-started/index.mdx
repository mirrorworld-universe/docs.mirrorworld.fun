...
issues with your account, you can <span onClick = {() =>
{window.mixgather.event("contact_us")}}>[contact us](mailto:sdk@mirrorworld.fun)</span>
or join our<span onClick={() => {window.mixgather.event("join_telegram")}}>
[Discord](https://mirrorworld.fun/discord)</span> and <span onClick={() =>{window.mixgather.event("join_discord")}}> [Telegram](https://mirrorworld.fun/telegram)</span> communities to report to our team directly.

![Create Account](/docs/images/tutorials/create-account.png)
...
Go ahead and click the "Add Project" button to start your first project! Enter
your project name in the popup and click "Create".

![Add Project](/docs/images/tutorials/add-project.png)
...
![Project Page Screenshot](/docs/images/tutorials/project-scrnsht1.png)

<p align="center">Visit from the Projects page</p>

![Project Page Screenshot](/docs/images/tutorials/project-scrnsht2.png)
