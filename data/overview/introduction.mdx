...
interfaces for building Mobile and Web Applications into Web 3 Architecture.
...
## Cross-chain support
Mirror World's SDKs and APIs support your mobile and web buidling needs across multiple chains. We're currently live on Solana,
and we're rolling out support for Ethereum, Polygon, BNB Chain, Aptos and Sui soon.
<ChainSupportTable />

## Why Mirror World?

### Seamless User Authentication 🌳
Mirror World provides user seamless user authentication
...
the ERC721/ERC1155/Metaplex standard. This makes it easy for you to organize your NFT collections on Web3.
