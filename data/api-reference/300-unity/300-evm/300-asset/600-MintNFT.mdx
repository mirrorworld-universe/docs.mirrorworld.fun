---
title: MirrorWorld.EVM.MintNFT
---

# `MirrorWorld.EVM.MintNFT`
...
MirrorWorld.EVM.MintNFT(parentCollection, collectionName, collectionSymbol, collectionUrl, confirmation, mint_id, receiveWallet, amount, null, (res) => {
    //todo
});
```