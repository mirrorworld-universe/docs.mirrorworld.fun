---
title: MirrorWorld.EVM.MintCollection
---
...
MirrorWorld.EVM.MintCollection(collectionName, collectionSymbol, collectionUrl, seller_fee_basis_points, null, null, (res) => {
    //todo
});
```