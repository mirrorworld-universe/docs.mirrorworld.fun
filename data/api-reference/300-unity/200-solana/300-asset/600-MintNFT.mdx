---
title: MirrorWorld.Solana.MintNFT
---

# `MirrorWorld.Solana.MintNFT`
...
MirrorWorld.Solana.MintNFT(parentCollection, collectionName, collectionSymbol, collectionUrl, confirmation, mint_id, receiveWallet, amount, null, (res) => {
    //todo
});
```