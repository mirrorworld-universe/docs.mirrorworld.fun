---
title: MirrorWorld.Solana.MintCollection
---
...
MirrorWorld.Solana.MintCollection(collectionName, collectionSymbol, collectionUrl, seller_fee_basis_points, null, null, (res) => {
    //todo
});
```