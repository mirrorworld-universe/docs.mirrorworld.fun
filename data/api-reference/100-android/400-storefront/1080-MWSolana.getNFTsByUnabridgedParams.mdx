---
title: MWSolana.getNFTsByUnabridgedParams
chain: EVM
---
...
MWSolana.getNFTsByUnabridgedParams(collection,page,pageSize,keyWord,desc,salePrice,filters, new GetNFTsListener() {
    @Override
