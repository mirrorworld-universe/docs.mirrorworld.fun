---
title: MWSolana.createVerifiedCollection
chain: Solana
---
...
MWSolana.createVerifiedCollection(activity, mintName, mintSymbol, metaDataUri, confirmation, new CreateTopCollectionListener() {
    @Override
