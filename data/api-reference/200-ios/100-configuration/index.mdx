...
Create a developer account on the Developer dashboard [Mirror World Official Site](https://app.mirrorworld.fun/) . Create project and create an API Key.
...
like this:
![Image text](https://github.com/mirrorworld-universe/mirrorworld-sdk-ios/blob/master/Example/MirrorWorldSDK/infoplist-UrlScheme-desc.png?raw=true)
