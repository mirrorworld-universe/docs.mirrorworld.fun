---
title: Mirror World Unity SDK Installation
description: Mirror World Unity SDK Installation
---

# Mirror World Unity SDK Installation
...
When a user opens your app, you may want to know whether this user has logged in before,instead of letting them login every time, you can call the following code to know that.
