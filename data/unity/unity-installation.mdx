...
- **Debug Email and Password**: In pre-release beta, you can only login SDK with this function. Input your email and password on https://docs.mirrorworld.fun.
...
When the user opens your app, you may want to know whether this user needs to log in, you can call the `IsLoggedIn` method. The boolean result is return in the callback.
```cs
