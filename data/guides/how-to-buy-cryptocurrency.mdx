...
1. User the your developer account to log into your smart wallet and click on
   **Buy** button.
2. Enter the amount of money you want to use to buy cryptocurrency (If you are a
   new user, you must to go through the KYC progress from Moonpay).
3. After completing the information and passing the bank's approval, you will
   receive the purchased currency in minutes.

| ![screen-shot](/images/tutorials/crypto-1.png) | ![screen-shot](/images/tutorials/crypto-2.png) |
| ---------------------------------------------- | ---------------------------------------------- |

> **Tips:**
>
> - Please providing the correct information, otherwise your account on Moonpay
>   might be banned and cannot use the on-ramp service again.
> - The final success of your order also depends on bank side, some banks might
>   have more stringent approval so that your order might be declined. Please
>   connect the bank to know more details when the order got decline.
...
personal information, and you are responsible for all consequences if you
...
as gas fee. For example if you wish to deploy your NFT or marketplace on Solana,
then your developer account will need to hold a certain amount of SOL to pay the
gas fee.
...
Congratulations on your successful purchase of cryptocurrency. Next, the asset
...
![截屏2023-01-28 下午4.33.46.png](/images/tutorials/crypto-3.png)
