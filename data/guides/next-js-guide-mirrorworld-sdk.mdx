...
In order to start using the SDK, you’ll need to
[create a developer account](https://app.mirrorworld.fun/auth/login). Your
account grants you access to all the features needed to build on mirror world
and it can be created within seconds. If you run into any issues creating an
account, Mirror World has active communities on
