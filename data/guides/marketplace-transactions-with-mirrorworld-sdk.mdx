...
### Pre-requisites
1. You have created and minted your NFT collection and minted NFTs into it. If you haven't already done this, please follow this guide to [Creating NFT collections](https://mirrorworld.fun/docs/guides/how-to-create-solana-nft-collection)
...
> After creating you marketplace, please take not of the `auction_house` address returned from the API. We shall use this
> in the rest of the guide. If you created your marketplace from the developer dashboard, you can get it from the developer
> Marketplace page of Project Area on the [developer dashboard](https://app.mirrorworld.fun/dashboard)
