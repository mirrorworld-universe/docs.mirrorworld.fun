...
```json
{
    "name": "Mirror Jump #1",
    "symbol": "MJNFT",
    "description": "Mirror Jump is our tribute to Doodle Jump, powered by Mirror World SDK. We hope that this game will help players to better understand the fun aspects of Web3 games and help developers to better understand how to use the Mirror World SDK.",
    "image": "http://metadata-assets.mirrorworld.fun/mirror_jump/images/Rare_Pirate Captain.png",
    "seller_fee_basis_points": 425,
    "collection": {
        "name": "Mirror Jump NFT",
        "family": "Mirror Jump NFT"
    },
    "attributes": [
        {
            "trait_type": "Rarity",
