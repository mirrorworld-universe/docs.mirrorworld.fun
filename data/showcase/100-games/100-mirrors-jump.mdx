...
2. Init your SDK with adding MirrorSDK prefab, you can follow the documentation here: [InitWithPrefab](/integration/unity#manual-configuration-with-prefab)
...
5. Init your SDK with adding MirrorSDK prefab, you can follow the documentation here: [InitWithPrefab](/integration/unity#manual-configuration-with-prefab)
...
3. Init your SDK with adding MirrorSDK prefab, you can follow the documentation here: [InitWithPrefab](/integration/unity#manual-configuration-with-prefab)
