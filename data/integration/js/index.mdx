...
## Step 2 - Install the JS Mirror World SDK

The Mirror World SDK for JavaScript implements a TypeScript-compatible client
that can be used for both in the browser and Node.js. Install it with the package manager of your choice:
...
## Step 4 - Initialize SDK with API Key
...
JavaScript SDK for Mirror World. There are a few things you can do to proceed from here:
