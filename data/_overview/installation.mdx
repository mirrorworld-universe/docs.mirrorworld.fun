...
> Congrats! You're ready to use the toggle machine in your project.
...
Some extra functions need to be used to make it work:
...
There is a subtle difference between how JSX attributes are named across
...
- Vue: You need to ensure the value is a string with a unit.
  `{ marginBottom: "4px" }`.
...
> patterns into a statechart so you never have to reinvent the wheel.

Thanks for reading! If you're curious about how state machines work, the next
the page will give you a quick overview.
