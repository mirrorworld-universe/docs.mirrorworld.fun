...
window.open("https://mirrorworld.fun/discord")}}>[Community
discord](https://mirrorworld.fun/discord)</span>. or <span onClick = {()=> {
window.mixgather.event("join_discord")
window.open("https://mirrorworld.fun/telegram")}}>[Telegram](https://mirrorworld.fun/telegram)</span> for
