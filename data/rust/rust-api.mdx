...
let result = get_nft_details("mint_address");
let response = if let Ok(Some(response)) = result {
    response
} else {
    todo!()
...
let parent_collection: String = String::from("your parent collection"); // your parent collection
...
let price: f64 = 0.5; // amount in SOL
let auction_house: String = String::from("your auction house address");
let response = market.buy_nft(mint_address, price, auction_house).await.unwrap();
```
...
let price: f64 = 0.5; // amount in SOL
let auction_house: String = String::from("your auction house address");
let response = market.update_nft_listing(mint_address, price, auction_house).await.unwrap();
```
...
let price: f64 = 0.5; // amount in SOL
let auction_house: String = String::from("your auction house address");
let response = market.cancel_nft_listing(mint_address, price, auction_house).await.unwrap();
```

### update nft
```cs
let mint_address = String::from("nft mint address");

let payload = UpdateNftPayload{
        mint_address,
        name: String::from("nft name"),
        update_authority: String::from("your update authority"),
        symbol: String::from("your symbol"),
        url: String::from("nft metadata uri"),
