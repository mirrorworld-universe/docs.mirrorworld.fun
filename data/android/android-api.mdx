...
### setWebviewNotice
Our login page is not compatible with some low version webview.So when the target webview is lower than limit,we will show notice.
...
### FetchUser
Try to get current user's details.
